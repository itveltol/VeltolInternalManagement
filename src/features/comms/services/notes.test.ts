...
import { assembleThreads, replyCountByRoot, unreadCount, groupNotificationsByAge, isDueSoon, anchorLabel } from "./notes";
...
describe("anchorLabel", () => {
  it("labels a matrice-anchored note with its activity name", () => {
