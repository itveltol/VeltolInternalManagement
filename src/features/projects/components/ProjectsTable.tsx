...
const INPUT_CLASS =
  "h-8 w-24 rounded-lg border border-border bg-veltol-surface/60 px-2.5 py-1 font-mono text-[12px] text-veltol-fg outline-none placeholder:text-veltol-fgMute focus:border-veltol-accent/50 focus:ring-2 focus:ring-veltol-accent/20";
                    ...
                    <td className="px-5 py-3.5">
                      ...
                      <div className="mt-0.5 text-[11px] text-veltol-fgDim">
                        ...
                        {project.project_category !== "residential" && project.project_type && (
                          <> · {tType(project.project_type as ProjectType)}</>
                        )}
                      </div>
                    </td>
                    ...
                    <td className="px-5 py-3.5">
                      <div className="flex flex-wrap gap-1">
                        {project.contract_type.map((c) => (
                          <Badge key={c} variant="outline" title={tContractType(c)}>
