  ...
  return (
    <Dialog.Root open={open} onOpenChange={onOpenChange}>
      <Dialog.Portal>
        ...
        <Dialog.Popup className="fixed inset-y-0 left-0 z-50 flex h-full w-72 max-w-[85vw] flex-col border-r border-border bg-card shadow-2xl data-open:animate-in data-open:slide-in-from-left data-closed:animate-out data-closed:slide-out-to-left">
          <Dialog.Title className="sr-only">Navigation</Dialog.Title>

          {/* Brand lockup */}
          <div className="flex h-[62px] shrink-0 items-center gap-2.5 border-b border-border px-5">
            <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-veltol-primary text-[13px] font-bold text-white">
              V
            </div>
            <div>
