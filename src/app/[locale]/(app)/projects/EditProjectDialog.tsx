              ...
              <div className="space-y-1.5">
                ...
                >
                  {PROJECT_PHASES.map((p) => (
                    <option key={p} value={p} className="bg-veltol-deep">
                      {tPhase(p)}
                    </option>
                  ))}
                </select>
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="space-y-1.5">
                ...
                <Input
                  ...
                  type="number"
                  min="0"
                  defaultValue={project.value_eur ?? ""}
                />
              </div>
            </div>
              ...
              <div className="space-y-1.5">
                ...
                >
                  {PROJECT_STATUSES.map((s) => (
                    <option key={s} value={s} className="bg-veltol-deep">
                      {tStatus(s)}
                    </option>
                  ))}
                </select>
            ...
            <div className="flex gap-6">
              <label className="flex cursor-pointer items-center gap-2">
                <input
                  ...
                  name="cu_issued"
                  value="true"
                  defaultChecked={project.cu_issued}
                  className="h-4 w-4 rounded border border-white/20 bg-veltol-surface accent-veltol-aqua"
                />
              ...
              <label className="flex cursor-pointer items-center gap-2">
                <input
                  ...
                  name="atr_issued"
                  value="true"
                  defaultChecked={project.atr_issued}
                  className="h-4 w-4 rounded border border-white/20 bg-veltol-surface accent-veltol-aqua"
                />
                <span className="font-mono text-[11px] text-veltol-fgDim">
                  {t("fields.atrIssued")}
